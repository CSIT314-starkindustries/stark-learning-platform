...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/searchResult.js"></script>
			...
			<div class="container-fluid">
				<div class="row" style="background: #F2F2F2;">
					<div class="d-flex w-100 mt-2">
						<div class="col-md-12 d-flex align-items-center justify-content-start">
							<small>
								<a href="/studentHome?username=${loggedInUser}" style="color: #588da8;"><i class="far fa-hand-point-left mr-1"></i>Back to Forum</a>
							</small>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<table class="table table-hover text-center table-responsive-md">
					  	...
					  	<tbody>
					  		<c:forEach items="${searchResults}" var="question" varStatus="loop">
						    	<tr class="d-flex" id="searchResultTableRow">
						      		...
						      		<td class="col-2 text-center" id="userIdCol">
						      			<a href="viewStudentProfile?username=${loggedInUser}&view_username=${question.stud_username}" id="userId">${question.stud_username}</a>
						      		</td>
						      		<td class="col-3 text-center" id="voteCountCol">${question.total_votes}</td>

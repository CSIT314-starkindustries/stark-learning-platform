		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-6" style="border: 1px solid black">
					<div class="row">
						<p class="col-md-3 font-weight-bold" style="border: 1px solid red;">Requested By: </p>
						<p class="" style="border: 1px solid red">ModXXX</p>
					</div>
				</div>
				<div class="col-md-6" style="border: 1px solid black">
					<p class="font-weight-bold">Date Requested: </p>
					<p>28-4-2020</p>
				</div>
			</div>
		</div>
